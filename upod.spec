# upod.spec
#
# Copyright (c) 2002 Nathan Hjelm hjelmn@unm.edu
#
%define name upod
...
#Icon:
#URL:
#Packager: Nathan Hjelm hjelmn@unm.edu
...
Summary: upod is an API for modifying the iTunesDB and the contents of an iPod.
